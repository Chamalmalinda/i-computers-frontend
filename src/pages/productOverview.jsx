    ...
    return(
      ...
      }
      {
        ...
        <div className="w-full h-[calc(100vh-100px)] flex">
            ...
            <div className="w-full">{product.labelledPrice > product.price && (
            ...
            <div className="w-full flex flex-row gap-4 mt-4">
                ...
                }} className=" border-2 border-accent text-secondary px-6 py-3 rounded hover:bg-accent hover:text-white transition">
                Buy Now
                </button>
                </div>   
